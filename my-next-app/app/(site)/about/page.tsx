    ...
    <div className="min-h-screen bg-neutral-950">
      <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <span className="yh-animate-up inline-block rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.35em] text-neutral-400">
            About
          </span>
        ...
        <div className="mt-16 grid gap-5 sm:grid-cols-3">
          {blocks.map((b, i) => (
            <div
              key={b.title}
              className={`rounded-2xl border border-white/[0.08] bg-neutral-900 p-8 shadow-md transition duration-300 hover:-translate-y-0.5 hover:border-white/20 hover:shadow-lg hover:shadow-black/40 yh-animate-up ${
